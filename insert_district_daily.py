...
def main():
    ...
    #Creating district_case_number in mysql
    ...
    print(f'Creating district_case_number at : {start_district_case}')
    conn_mysql_2, cur_mysql_2 = connection.connect_to_mysql(conf_mysql)
    create_data.create_dim_table(conn_mysql,
                                cur_mysql,
                                conf_postgres,
                                '/root/final-project/sql_script/district_case_number.sql',
                                'district')
    end_district_case = datetime.now()
    duration_district_case = end_district_case - start_district_case
    print(f'Successfully created district_case_number at {end_district_case}.. Duration: {duration_district_case}')
    ...
    create_data.create_dim_table(conn_postgre,
                                cur_postgre,
                                conf_postgres,
                                '/root/final-project/sql_script/fact_district_daily.sql',
                                'district_daily'
                                )
